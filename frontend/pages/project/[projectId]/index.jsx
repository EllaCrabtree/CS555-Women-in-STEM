...
const Project = () => {
    ...
    useEffect(() => {
        async function getReviews(uuid) {
            try {
        ...
        if (auth.authUser) {
            async function getData(uuid) {
                try {
                    ...
                    if (
                        dataArray[0].Construction_Team.includes(
                            auth.authUser.uid
                        )
                    ) {
                        setAddTask(
            ...
            return (
                <div className="whitePageWrapper">
                    ...
                    <main className="content">
                        ...
                        <h2 className={styles.projectMainName}>
                            Rating:{" "}
                            {reviews.length !== 0
                                ? reviews.reduce(
                        ...
                        <div
                            className={styles.boxtabContainer}
                            id="photos-container"
                        >
                            <img
            ...
            return (
                <div className="whitePageWrapper">
                    ...
                    <main className="content">
                        ...
                        <p className={styles.projectSubinfo}>
                            Fecha de Inicio de Etapa: 1/01/2023 | Fecha de
                            Inicio del Proyecto: 1/01/2023
                        </p>
                        <Link href={`/projects`}>
