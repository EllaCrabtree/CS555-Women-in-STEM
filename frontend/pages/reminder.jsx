				...
				<main className="content">
					...
					<form
						...
						onSubmit={async (e) => {
							...
							if (reminder.ProjectID === "" || reminder.TaskID === "") {
				...
				<main className="content">
					...
					<form
						...
						onSubmit={async (e) => {
							...
							if (reminder.ProjectID === "" || reminder.TaskID === "") {
								alert("Seleccione un proyecto y una tarea");
								return;
							}
					...
					>
						...
						<label htmlFor="Title">Nombre del recordatorio</label>
						<input
							type="text"
							name="Title"
							id="Title"
						...
						/>
						<label htmlFor="Due_Date">Fecha para Recordar</label>
						<input
							type="date"
							id="Due_Date"
							name="Due_Date"
